...
const AddAuthorDetailsModels = ({ addAuthorDetailsModels, setAddAuthorDetailsModels }) => {
     return (
          <div className={`${addAuthorDetailsModels ? "block" : "hidden"} w-[50rem]  h-auto items-center justify-center fixed top-[6rem] left-[30rem]  z-[999999999999] p-4 rounded-sm bg-[#0E2A10] text-[#0E2A10] border border-white/20 `}>
               <div className='border border-gray-400 rounded-sm shadow-2xl p-4 bg-[#87a186]'>
                    ...
                    <form method='' className='w-full'>
                         <div className=''>
                              ...
                              <input type="text" className='bg-[#2b572a]/30 outline-0 w-full placeholder:text-sm placeholder:text-gray-700 text-start px-6 py-1 rounded-sm' placeholder='Add Author Name here' />
                         </div>
                         <div className='my-3'>
                         ...
                         <div className='my-3'>
                              ...
                              <input type="text" className='bg-[#2b572a]/30 py-2 w-full placeholder:text-sm placeholder:text-gray-700 outline-0 text-start px-6 rounded-sm' placeholder='Add Number Here' />
                         </div>
