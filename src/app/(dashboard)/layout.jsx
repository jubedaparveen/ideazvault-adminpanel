...
export default function DashboardLayout({ children }) {
    return (
        ...
        <div className="h-screen flex ">
            <div className=" md:w-[25%] w-[8%] sm:w-[8%] bg-[#0E2A10] text-white md:p-4 sm:p-4 p-2">
                <div className=" sm:p-2 md:p-4 md:border md:border-gray-700/50 rounded-lg"> 
                    <Sidebar />
                </div>
            </div>
            <div className=" md:w-[75%] w-[92%]  bg-[#87a186] border-l border-gray-800/50 overflow-y-auto h-[calc(100%-.1rem)]">
                <div>
                    <Navbar />
                </div>
