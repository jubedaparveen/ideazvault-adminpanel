...
import EditTacnicalBlogsModels from '@/Models/EditTacnicalBlogsModels';

const TecnicalBlogs = () => {

  const [TecnicalEditModel, setTecnicalEditModel] = useState(false)
  ...
  return (
    <div className='p-4   '>
                  ...
                  <tr className=' border-b-2 border-[#87a186]/20 hover:bg-[#0E2A10] hover:text-[#e0cbb0]'>
                    ...
                    <td className='p-1 border-r text-center '>
                      <div className='flex flex-col md:flex-row gap-2  justify-center items-center  md:justify-start'>
                        ...
                        <button className='border border-[#87a186]/20 bg-[#87a186] text-[#0E2A10] hover:bg-[#0E2A10] hover:text-[#e0cbb0] p-1 rounded-2xl hover:border-[#e0cbb0]' onClick={()=>setTecnicalEditModel(true)}><RiEdit2Fill /></button>
          ...
          <EditTacnicalBlogsModels TecnicalEditModel={TecnicalEditModel} setTecnicalEditModel={setTecnicalEditModel}/>
        </div>
  )
}
